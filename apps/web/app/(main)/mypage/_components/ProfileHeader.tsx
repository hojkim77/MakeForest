    ...
    <section className="bg-surface-container p-lg border-2 border-outline shadow-island">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <div className="text-4xl bg-surface-container-highest p-3 border-2 border-outline shadow-island">
            {user.avatarUrl
...
export function ProfileHeaderSkeleton() {
  return (
    <div className="bg-surface-container p-6 border-2 border-outline shadow-island animate-pulse">
      <div className="flex items-center gap-4">
        <div className="w-16 h-16 bg-surface-container-highest border-2 border-outline shadow-island" />
